...
cookingApp.controller('RecipeEditController', ['$scope', '$rootScope', '$location','uploadManager', 'Recipe', 'recipe', 
  function($scope, $rootScope, $location, uploadManager, Recipe, recipe) {
...
cookingApp.directive('upload', ['uploadManager', function factory(uploadManager) {
    return {
        restrict: 'A',
        link: function (scope, element, attrs) {
            $(element).fileupload({
